...
\]
is a flute (of height $n-1$).

2) Given a flute $(a_0, \ldots, a_n)$, there exists a arithmetic frieze pattern $f$ of height $n+1$ such that
\[
    (f (1,0), \ldots, f (n,0)) = (a_0, \ldots, a_n).
\]
\end{proposition}
\begin{proof}
...
\begin{corollary}
    ...
    \lean{friezeNonEmpty}
    \uses{l:kFluteNonEmpty, prop:friezeToFlute}
