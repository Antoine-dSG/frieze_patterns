...
\begin{corollary}
    ...
    \uses{l:nFluteNonEmpty, prop:friezeToFlute}
    \lean{arithFriezePatSetNonEmpty}
    \leanok
...
\begin{corollary}
    ...
    \lean{maxDefined}
    \leanok
    \uses{prop:friezeToFlute, prop:FluteBounded,c:arithFriezePatSetNonEmpty}
...
\begin{theorem}
    \label{mainTheorem}
    \lean{mainTheorem}
    \uses{l:maxDefined, prop:FluteBounded, l:FibFlute, prop:friezeToFlute}
