...
\begin{proposition}
    \uses{def:flute,def:arith_fp, l:pattern_nContinuant,prop:translationInvariance}
...
\begin{theorem}
    ...
    \leanok
    \uses{prop:FluteBounded, l:FibFlute, prop:friezeIffFlute,c:arithFriezePatSetNonEmpty}
